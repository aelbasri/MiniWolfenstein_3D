...
SRCS = $(addprefix ./src/, cub3d.c cub3d_utils.c minimap.c  parse_map.c movement/player_movement.c rendering/ft_animation.c rendering/rendering.c raycaster/raycasting.c rendering/rendering_utils.c raycaster/raycasting_utilse.c)#parse_map.c cub3d.c minimap.c #libft/ft_strlen.c libft/ft_strchr.c libft/ft_strjoin.c libft/ft_strdup.c #get_next_line/get_next_line.c 
