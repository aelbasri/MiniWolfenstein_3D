...
/*   Updated: 2024/08/27 13:32:31 by aelbasri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			check_direction_horizontal(t_ray_cast *cast, \
				t_data *data, double angle);
void			check_direction_vertical(t_ray_cast *cast, \
				t_data *data, double angle);
void			get_intersections_horizontal(t_ray_cast *cast, \
				t_ray *ray, t_data *data, double angle);
void			get_intersections_vertical(t_ray_cast *cast, \
				t_ray *ray, t_data *data, double angle);
